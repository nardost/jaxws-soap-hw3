 ...
 * 
 */
@WebServiceClient(name = "QuoteServiceService", targetNamespace = "http://service.jaxws.ntessema.depaul.edu/", wsdlLocation = "http://localhost:8888/endpoint?wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    private final static QName QUOTESERVICESERVICE_QNAME = new QName("http://service.jaxws.ntessema.depaul.edu/", "QuoteServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8888/endpoint?wsdl");
    ...
    public edu.depaul.ntessema.jaxws.client.generated.Service getQuoteServicePort() {
        return super.getPort(new QName("http://service.jaxws.ntessema.depaul.edu/", "QuoteServicePort"), Service.class);
    }
     ...
     */
    @WebEndpoint(name = "QuoteServicePort")
    public edu.depaul.ntessema.jaxws.client.generated.Service getQuoteServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.jaxws.ntessema.depaul.edu/", "QuoteServicePort"), Service.class, features);
    }
