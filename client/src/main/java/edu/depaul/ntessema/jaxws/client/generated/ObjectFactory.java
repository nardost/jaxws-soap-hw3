 ...
 * generated in the edu.depaul.ntessema.jaxws.client.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _ServiceMethodResponse_QNAME = new QName("http://service.jaxws.ntessema.depaul.edu/", "serviceMethodResponse");
    private final static QName _ServiceMethod_QNAME = new QName("http://service.jaxws.ntessema.depaul.edu/", "serviceMethod");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.depaul.ntessema.jaxws.client.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.ntessema.depaul.edu/", name = "serviceMethodResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.ntessema.depaul.edu/", name = "serviceMethod")
